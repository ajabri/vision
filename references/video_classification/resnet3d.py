...
def batchnorm(x):
    return nn.BatchNorm3d(midplanes)
    # return nn.Identity()
...
class Conv3DSimplePad(nn.Module):
    def __init__(self,
        ...
        self.pieces = nn.Sequential(
            ReplicationPad3d((padding, padding, padding, padding, padding, padding)),
...
class Conv3DNoTemporalPad(nn.Module):
...
class Conv2Plus1DPad(nn.Sequential):
...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        self.layer1 = self._make_layer(block, conv_makers[0], 64, layers[0], stride=2)
...
def r2d_10(pretrained=False, progress=True, **kwargs):
    """Constructor for 18 layer Mixed Convolution network as in
    https://arxiv.org/abs/1711.11248
