...
import utils
class VQ(nn.Module):
    def __init__(self, K=100, temp=0.05):
    ...
    def forward(self, x):
        ...
        K = utils.log_sinkhorn_knopp(K/self.temp, n_iters=4)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, padding=None, residual=False):
        ...
        self.conv2 = conv3x3(width, width, stride, groups, dilation, padding=padding)
