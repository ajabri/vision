...
class JhmdbSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # lbls_tensor = torch.cat([ lbls_tensor[0][None]]*self.videoLen  + [lbls_tensor], dim=0) 
        ...
        # lbls_tensor = torch.from_numpy(np.stack(lbls_tensor))
    ...
    def load_jhmdb_labels(label_path):
